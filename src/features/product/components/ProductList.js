...
import { ITEMS_PER_PAGE } from "../../../app/constent";
...
export function ProductList() {
  ...
  const catagories = useSelector(selectAllCatagories);
  ...
  const handelFilter = (e, section, option) => {
    ...
    if (e.target.checked) {
      ...
      const index = delete newFilter[section.id].findIndex(
        (el) => el === option.value
      );
      ...
      <div className="bg-white">
        <div>
          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            {/* section of products and filter ends */}
            {/* pagination start */}
...
function DesktopFilter({ page, setPage, filters, handelFilter }) {
  return (
    <>
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
            ...
            <div
              onClick={(e) => handelPage(totalPages > page ? page + 1 : page)}
              ...
              <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                {products.map((product) => (
                  <Link to={`/product-details/${product.id}`} key={product.id}>
                    <div
                      key={product.id}
                      className="group relative border-solid border-2 p-2 border-gray-200 p-2"
                    >
                      ...
                      <div className="mt-4 flex justify-between">
                        ...
                        <div>
                          <p className="text-sm line-through font-medium text-gray-1000">
                            ${product.price}
                          </p>
